...
Funcionario *maisVelhoLista(Funcionario *cabeca)
{
    Funcionario *aux = cabeca, *velho;
    ...
    while (aux != NULL)
    {
        if (velho->nascimento.ano > aux->nascimento.ano) //compara o ano
            velho = aux;
        else if (velho->nascimento.ano == aux->nascimento.ano)
        {
            if (velho->nascimento.mes > aux->nascimento.mes) //compara o mes, considerando q o ano já é igual
                velho = aux;
            else if (velho->nascimento.mes == aux->nascimento.mes)
            {
                if (velho->nascimento.dia > aux->nascimento.dia) //compara o dia, considerando q o ano já é igual e o mes também
                    velho = aux;
            }
        }
...
int main()
{
    ...
    maiorAno = maisVelhoLista(primeiro);
    printf("------------------------\n");
    printf("Funcionario Mais Velho\n");
    printf("Ano de nascimento: %d \n", maiorAno->nascimento.ano);
    printf("-----------------------------\n");
